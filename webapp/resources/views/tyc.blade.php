...
<div class="uk-container">
	<div class="uk-width-1-1 uk-width-expand@m uk-grid-margin uk-first-column">
		<hr>
		<div class="uk-card uk-card-default uk-card-small tm-ignore-container" style="min-height:200px;">
			<br>
			<p style="padding:20px;">TÉRMINOS DE SERVICIO

----

INFORMACIÓN GENERAL

Este sitio web es operado por OutletDeCafe. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a OutletDeCafe. OutletDeCafe ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.
...
Estas Condiciones del servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de Av. Santa Fe 1200, CABA, B, 1425, Argentina.
...
Preguntas acerca de los Términos de Servicio deben ser enviadas a realidadargentinaoficial@gmail.com.</p>
		</div>
		<hr>
	</div>
</div>
